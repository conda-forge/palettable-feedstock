About palettable-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/palettable-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3185&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/palettable-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `palettable` can be installed with `conda`:
...
```
mamba install palettable
```

It is possible to list all of the versions of `palettable` available on your platform with `conda`:
...
```
mamba search palettable --channel conda-forge
```
...
mamba repoquery search palettable --channel conda-forge

# List packages depending on `palettable`:
mamba repoquery whoneeds palettable --channel conda-forge

# List dependencies of `palettable`:
mamba repoquery depends palettable --channel conda-forge
```
